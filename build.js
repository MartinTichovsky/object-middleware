...
const loadAndMergeConfig = (fileName) => {
    ...
    return tsconfig.extends ? deepMerge(loadAndMergeConfig(tsconfig.extends), tsconfig) : tsconfig;
};
...
const checkRequiredProperties = (tsconfigPath, tsconfig) => {
    ...
    if (!tsconfig.include) {
        errors.push(`Missing input directory 'include' in config '${tsconfigPath}'`);
    }
